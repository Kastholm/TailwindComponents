...
<template>
  ...
  <div class="flex h-full">
              ...
              <div class="flex flex-shrink-0 border-t border-slate-200 p-4">
                <a href="#" class="group block flex-shrink-0">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      <p
                        class="text-base font-medium text-slate-700 group-hover:text-slate-900"
                      >
                        Lisa Marie
                      </p>
                      <p
    ...
    <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div class="lg:hidden">
        <div
          class="flex items-center justify-between bg-blue-600 px-4 py-2 sm:px-6"
        >
          <div>
            <img
              class="h-8 w-auto"
      ...
      <main class="flex flex-1 overflow-hidden">
        <div class="flex flex-1 flex-col overflow-y-auto xl:overflow-hidden">
          ...
          >
            <div
              class="mx-auto flex max-w-3xl items-start px-4 py-3 sm:px-6 lg:px-8"
            >
              <a
                href="#"
          ...
          <div class="flex flex-1 xl:overflow-hidden">
            ...
            <nav
              aria-label="Sections"
              class="hidden w-96 flex-shrink-0 border-r border-slate-200 bg-white xl:flex xl:flex-col"
            >
              <div
                class="flex h-16 flex-shrink-0 items-center border-b border-slate-200 px-6"
              >
            ...
            <div class="flex-1 xl:overflow-y-auto">
              <div
                class="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12"
              >
                  ...
                  >
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-2 flex rounded-md shadow-sm">
                        <span
                          class="inline-flex items-center rounded-l-md border border-r-0 border-slate-300 bg-white px-3 text-slate-500 sm:text-sm"
                          >workcation.com/</span
                        >
                        <input
                          type="text"
                          ...
                          value="lisamarie"
                          class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-2 flex items-center">
                        ...
                        <div class="relative ml-4">
                          ...
                          <label
                            for="user-photo"
                            class="pointer-events-none block rounded-md bg-white px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 peer-hover:bg-slate-50 peer-focus:ring-2 peer-focus:ring-blue-600"
                          >
                            <span>Change</span>
                        ...
                        <button
                          type="button"
                          class="ml-6 text-sm font-medium leading-6 text-slate-900"
                        >
                          Remove
                        </button>
                      </div>
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-2">
                        <textarea
                          ...
                          name="description"
                          rows="4"
                          class="block w-full rounded-md border-0 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:py-1.5 sm:text-sm sm:leading-6"
                        />
                      </div>
