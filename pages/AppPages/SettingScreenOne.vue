          ...
          >
              ...
              <div class="w-full max-w-lg lg:max-w-xs">
                ...
                <div class="relative text-sky-100 focus-within:text-gray-400">
                  ...
                  <input
                    id="search"
                    name="search"
                    class="block w-full rounded-md border-0 bg-sky-700/50 py-1.5 pl-10 pr-3 text-white placeholder:text-sky-100 focus:bg-white focus:text-gray-900 focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6"
                    placeholder="Search"
                    type="search"
                  />
                </div>
            ...
            <div class="flex lg:hidden">
              ...
              >
                ...
                <Bars3Icon
                  v-if="!open"
                  class="block h-6 w-6 flex-shrink-0"
                  aria-hidden="true"
                />
                <XMarkIcon
                  v-else
          ...
          <div class="border-t border-sky-800 pb-3 pt-4">
            ...
            <div class="mt-3 px-2">
              <DisclosureButton
                ...
                as="a"
                :href="item.href"
                class="block rounded-md px-3 py-2 text-base font-medium text-sky-200 hover:bg-sky-800 hover:text-white"
                >{{ item.name }}</DisclosureButton
              >
            </div>
          </div>
            ...
            >
              ...
              <div class="px-4 py-6 sm:p-6 lg:pb-8">
                ...
                <div class="mt-6 flex flex-col lg:flex-row">
                  ...
                  <div
                    class="mt-6 flex-grow lg:ml-6 lg:mt-0 lg:flex-shrink-0 lg:flex-grow-0"
                  >
                    <p
